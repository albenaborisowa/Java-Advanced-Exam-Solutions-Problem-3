...
public class Main {
    public static void main(String[] args) {
        ...
        //Initialize entity
        parrots.Parrot parrot = new parrots.Parrot("Fluffy", "Loriinae");
        //Print Parrot
...
//Remove Parrot
        ...
        parrots.Parrot secondParrot = new parrots.Parrot("Bunny", "Cacatuidae");
        parrots.Parrot thirdParrot = new parrots.Parrot("Jumpy", "Strigopoidea");
        parrots.Parrot fourthParrot = new parrots.Parrot("Puffy", "Strigopoidea");
        parrots.Parrot fifthParrot = new parrots.Parrot("Marlin", "Arinae");
